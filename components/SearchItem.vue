...
<template>
    <div class="w-full rounded-md max-h-[72px] transition-all duration-300 ease-in hover:bg-[#18181b] hover:scale-[102.5%]">
        <div class="flex justify-start items-center px-4 py-3 whitespace-pre-line">
            <Card class="mr-2">
